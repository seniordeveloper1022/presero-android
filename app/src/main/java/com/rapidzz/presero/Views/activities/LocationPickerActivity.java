...
public class LocationPickerActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public boolean isMarkerPlaced=false;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        autoCompleteLocation.setPlaceListener(new OnPlaceLoadListener() {
            @Override
            public void onPlaceLoad(@NonNull Place place) {
                ...
                addMarker();
                animateCameraForNewLocation();
            }
        });

        autoCompleteLocation.setAutoCompleteTextListener(new AutocompleteLocationListener() {
            @Override
            ...
            @Override
            public void onItemSelected(@org.jetbrains.annotations.Nullable AutocompletePrediction autocompletePrediction) {
              //  userAddress = autocompletePrediction.toString();
   ...
   /*     imgSearch.setOnClickListener(new View.OnClickListener() {
        ...
        txtSelectLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(MapUtility.ADDRESS, autoCompleteLocation.getText().toString());
...
//                getSettingsLocation();
    ...
    private void addMarker() {
        if (mMap != null) {
            try {
                autoCompleteLocation.setText(""+userAddress);
               if(!isMarkerPlaced) {
                   if(mLatitude!=0.0) {
                       isMarkerPlaced = true;
                       animateCameraForNewLocation();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnCameraIdleListener(new GoogleMap.OnCameraIdleListener() {
            ...
            public void onCameraIdle() {
                ...
                mLatitude = midLatLng.latitude;
                mLongitude = midLatLng.longitude;
                LocationPickerActivity.this.addMarker();
                if (!MapUtility.isNetworkAvailable(LocationPickerActivity.this)) {
                    MapUtility.showToast(LocationPickerActivity.this, "Please Connect to Internet");
                }
    ...
    private void animateCameraForNewLocation()
    {
    ...
    private void reverseGeoCode(Double lat,Double lng)
    {
        ...
        SmartLocation.with(this).geocoding().reverse(location1, new OnReverseGeocodingListener() {
            @Override
